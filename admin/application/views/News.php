                ...
                <div class="col-md-10">
                    <div class="box box-primary">
                        <div class="box-header">
                            <a href="<?php echo base_url() ?>news_add" class="btn btn-default pull-right"><i class="fa fa-plus"></i> Add New</a>
                        </div>
    ...
    var loadCategory = function(){
        ...
        var links = function (row, datafield, value) {
            ...
            return '<div class="render-links">' +
                '<a title="Details" class="btn btn-default btn-xs btn-flat fg-gray" href=news_view/'+ id +'><i class="fa fa-eye"></i> View' +
                '<a title="Details" class="btn btn-default btn-xs btn-flat fg-gray" href=news_edit/'+ id +'><i class="fa fa-pencil-square-o"></i> Edit </i></a>' +
        ...
        $("#jqxgrid").jqxGrid(
            {   width:900,
                ...
                columns: [
                    ...
                    { text: 'Posted By', datafield: 'PostedBy', width: 150},
